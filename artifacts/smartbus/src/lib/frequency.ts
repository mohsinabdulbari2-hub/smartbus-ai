 ...
 *
 * Weekday patterns (BMTC operational data):
 *   Late night  (23:00–04:59) →  3/hr  (Night Owl services only)
 *   Pre-dawn    (05:00–05:59) →  5/hr  (early depot departures)
 *   Morning pk  (06:00–09:59) → 16/hr  (max fleet on road)
 *   Midday      (10:00–15:59) → 11/hr  (reduced but steady)
 *   Evening pk  (16:00–20:59) → 17/hr  (highest demand)
 *   Wind-down   (21:00–21:59) →  6/hr  (post-peak taper)
 *   Late eve    (22:00–22:59) →  4/hr
 *
 * Weekend: ~55–60% of weekday volumes on most routes.
 */
...
export function fuseFrequency(
  ...
  // The DB base is clamped to the realistic ceiling for the current slot.
  ...
  // Hard ceiling — never exceed what's realistic for this slot/day
