...
const s = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontFamily: "Inter_700Bold", color: "#0f172a", letterSpacing: -0.5 },
  ...
  searchInput: { flex: 1, fontSize: 14, fontFamily: "Inter_500Medium", color: "#0f172a" },
  filterTab: {
    flexDirection: "row",
    alignItems: "center",
    gap: 4,
  ...
  filterLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: "#64748b" },
  ...
  resultText: { fontSize: 12, fontFamily: "Inter_400Regular", color: "#64748b" },
  ...
  cardName: { fontSize: 12, fontFamily: "Inter_600SemiBold", color: "#0f172a" },
  ...
  emptyText: { fontSize: 15, fontFamily: "Inter_500Medium", color: "#64748b" },
});
