...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 18, fontFamily: "Inter_600SemiBold", color: "#475569" },
  emptySubtitle: { fontSize: 14, fontFamily: "Inter_400Regular", color: "#334155", textAlign: "center" },
  summaryRow: {
    flexDirection: "row",
    marginHorizontal: 20,
    marginTop: 16,
  ...
  summaryValue: { fontSize: 20, fontFamily: "Inter_700Bold", color: "#f1f5f9" },
  summaryLabel: { fontSize: 10, fontFamily: "Inter_400Regular", color: "#475569", marginTop: 2 },
  ...
  filterTabText: { fontSize: 13, fontFamily: "Inter_600SemiBold", color: "#475569" },
  ...
  resultInfo: { flex: 1 },
  resultName: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#f1f5f9", marginBottom: 3 },
  ...
  resultMetaText: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#475569" },
  etaBox: { alignItems: "flex-end" },
  etaValue: { fontSize: 28, fontFamily: "Inter_700Bold", color: Colors.primary, lineHeight: 32 },
  etaUnit: { fontSize: 11, fontFamily: "Inter_600SemiBold", color: "#475569" },
  etaDiff: { fontSize: 11, fontFamily: "Inter_400Regular", color: "#475569", marginTop: 2 },
  resultBottom: {
    flexDirection: "row",
    alignItems: "center",
